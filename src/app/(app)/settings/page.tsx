...
export default function SettingsPage() {
  ...
  const handleSave = async () => {
    ...
    if (trimmedLink && !GITHUB_REPO_REGEX.test(trimmedLink)) {
      toast.error(
        'Invalid GitHub Repository URL. Use format: https://github.com/username/repo'
      )
      return
    }
    ...
    try {
      ...
      toast.success('GitHub details saved successfully!')
      setIsEditing(false)
    } catch {
      toast.error('Failed to save GitHub details')
    }
  }
  ...
  return (
    <div>
      ...
      <div className="card p-6 max-w-lg">
        ...
        {/* GitHub Integration - Tech Interns Only */}
        {user?.role === 'INTERN' && user?.squad === 'TECH' && (
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-100 flex items-center justify-between">
                ...
                <div className="flex gap-1.5 flex-shrink-0">
                  ...
                  <button
                    ...
                    aria-label="Edit GitHub Details"
                  >
                    <Edit3 size={12} />
                    {user.repoLink || user.githubUsername
                      ? 'Edit'
                      : 'Add Details'}
                  </button>
                </div>
